...
if TYPE_CHECKING:
    from .modeling_llmdet import LLMDetObjectDetectionOutput
...
class GroundingDinoImageProcessorFast(DetrImageProcessorFast):
    def post_process_object_detection(
        self,
        outputs: "LLMDetObjectDetectionOutput",
        threshold: float = 0.1,
        target_sizes: Optional[Union[TensorType, list[tuple]]] = None,
    ):
        """
        Converts the raw output of [`LLMDetForObjectDetection`] into final bounding boxes in (top_left_x, top_left_y,
